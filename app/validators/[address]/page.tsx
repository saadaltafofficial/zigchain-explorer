  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-4">
        ...
        <div className="flex items-center">
          ...
          <div className="ml-3">
            <p className="text-sm text-yellow-400">
              The validator details section is currently under maintenance. We're working on bringing you an improved experience soon.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-gray-800 shadow-md rounded-lg p-6 max-w-2xl w-full">
        <h1 className="text-2xl font-bold text-white mb-4">Validator Details</h1>
        <p className="text-gray-300 mb-6">
          This page will display detailed information about individual validators on the ZigChain network.
        </p>

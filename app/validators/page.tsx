...
export default function ValidatorsPage() {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-4">
      <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 max-w-2xl w-full mb-8">
      ...
      <div className="bg-white dark:bg-gray-800 shadow-md rounded-lg p-6 max-w-2xl w-full">
        <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Validators</h1>
        ...
        <div className="flex justify-center">
          <button 
            className="px-4 py-2 bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-200 rounded-md cursor-not-allowed opacity-70"
            disabled
          >
            View Validators
          </button>
